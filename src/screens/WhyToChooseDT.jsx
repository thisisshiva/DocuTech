...
const WhyToChooseDT = () => {
  return (
    ...
    <Card className="w-full max-w-[1234px] mx-auto mt-7 bg-[#f3d3b8] rounded-2xl shadow-lg">
      <CardContent className="p-6 sm:p-8 md:p-10 lg:p-12 flex flex-col sm:flex-row justify-between items-center gap-6 sm:gap-8 md:gap-10 lg:gap-12">
        ...
        <div className="flex-1">
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-[64px] leading-[45px] sm:leading-[50px] md:leading-[60px] lg:leading-[70px] text-[#343434] font-normal [text-shadow:0px_4px_4px_#00000040]">
